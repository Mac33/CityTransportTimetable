...
import com.bignerdranch.expandablerecyclerview.ParentViewHolder.IParentViewHolderExpandCollapseListener;
...
public abstract class ExpandableRecyclerAdapter<P extends Parent<C>, C, PVH extends ParentViewHolder, CVH extends ChildViewHolder>
    ...
    public interface ExpandCollapseListener {
        ...
        @UiThread
        void onFlatParentCollapsed(int flatPosition);
    ...
    private IParentViewHolderExpandCollapseListener mParentViewHolderExpandCollapseListener = new IParentViewHolderExpandCollapseListener() {

        /**
         * Implementation of {@link IParentViewHolderExpandCollapseListener#onParentExpanded(int)}.
         * <p>
        ...
        /**
         * Implementation of {@link IParentViewHolderExpandCollapseListener#onParentCollapsed(int)}.
         * <p>
    ...
    @UiThread
    public void collapseParentByFlatPosition(int flatPosition) {
       int parentPosition =  this.getNearestParentPosition(flatPosition);
       if (parentPosition >= 0)
       {
          collapseParent(mParentList.get(parentPosition));
           if (mExpandCollapseListener!=null) {
               mExpandCollapseListener.onFlatParentCollapsed(flatPosition-1);
           }
       }
