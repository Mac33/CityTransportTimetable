...
public class ParentViewHolder<P extends Parent<C>, C> extends RecyclerView.ViewHolder implements View.OnClickListener {
    @Nullable
    private IParentViewHolderExpandCollapseListener mParentViewHolderExpandCollapseListener;
     ...
     */
    interface IParentViewHolderExpandCollapseListener {
    ...
    /**
     * Setter for the {@link IParentViewHolderExpandCollapseListener} implemented in
     * {@link com.bignerdranch.expandablerecyclerview.ExpandableRecyclerAdapter}.
     *
     * @param parentViewHolderExpandCollapseListener The {@link IParentViewHolderExpandCollapseListener} to set on the {@link ParentViewHolder}
     */
    @UiThread
    void setParentViewHolderExpandCollapseListener(IParentViewHolderExpandCollapseListener parentViewHolderExpandCollapseListener) {
    ...
    public void onClick(View v) {
        if (mParent.getChildList().isEmpty()) {
            return;
        }
